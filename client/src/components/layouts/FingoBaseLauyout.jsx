...
import 'src/styles/FingoBaseLayout.styles.css'
...
export const FingoScrollToTop = ({ fixed }) => {
    ...
    function scrollToTop(e) {
        let rootElement = document.getElementById('FingoBaseLayout')
        if (rootElement) {
...
const FingoBaseLayout = ({ children }) => {
    return (
        <div id='FingoBaseLayout' className='FingoBaseLayout'>
            <div className='FingoBaseLayoutWrapper'>
                <div className='FingoBaseLayoutContainer'>{children}</div>
            </div>
            <FingoFooter />
            <ModalLogin />
            <ModalRegister />
...
export default FingoBaseLayout
