                            ...
                            <motion.header
                                ...
                                <div className='flex items-center justify-between w-full max-w-5xl px-8 mx-auto'>
                                    ...
                                    <div className="flex justify-between w-full">
                                        <span className={`flex items-center justify-end lg:text-lg text-sm font-bold whitespace-nowrap flex-1 mr-4 ${darkMode ? 'text-gray-700' : 'text-gray-950'} cursor-pointer`} onClick={() => navigate(`/contactus`)}>Contact Us</span>
                                        <Button
                                            style={{
                    ...
                    <div className="pt-40 mx-auto lg:pt-64 lg:pb-28 ">
                        <Reveal motionType={'zoom'}>
                            ...
                            <div className="flex items-center justify-center">
                                <h1 className={`scroll-m-20 text-xl font-extrabold tracking-tight lg:text-4xl py-4 ${darkMode ? 'text-gray-700' : 'text-gray-950'}`}>say goodbye to boring finance lessons.</h1>
                            </div>
                        ...
                        <div className="flex flex-col justify-between space-y-0 " >
                            <Reveal motionType={'rightToLeft'}>
                                ...
                                <div className="flex flex-col py-5 overflow-hidden rounded-md lg:flex-row ">
                                    ...
                                    <div className="flex-col items-start justify-center flex-1 hidden mx-auto md:flex sm:py-10 lg:py-0 ">
                                        ...
                                        <h3 className={`my-6 text-xl font-bold w-96 ${darkMode ? 'text-gray-700' : 'text-gray-950'}`}>choose from over 600 chapters, each only 3-4 minutes long</h3>
                                    ...
                                    <h3 className={`my-6 text-base md:text-xl font-bold w-60 ${darkMode ? 'text-gray-700' : 'text-gray-950 w-60'}`}>choose from over 600 chapters, each only 3-4 minutes long</h3>
                            ...
                            <Reveal motionType={"leftToRight"}>
                                <div className="flex flex-col w-full py-5 rounded-md lg:flex-row-reverse">
                                    ...
                                    <div className="flex-col justify-center items-center hidden lg:flex sm:py-10 lg:py-0">
                                        <div className="flex flex-col items-start justify-start">
                                            ...
                                            <h3 className={`-mt-20 text-xl font-bold w-96 ${darkMode ? 'text-gray-700' : 'text-gray-950'}`}>
                                ...
                                <div className="flex flex-col items-center justify-center w-3/4 pb-5 mx-auto my-auto mt-5 lg:hidden ">
                                    ...
                                    <h3 className={`my-1 text-base md:text-xl font-bold  ${darkMode ? 'text-gray-700' : 'text-gray-950 w-60'}`}>
                                        complete quizzes, earn XP points, and increase your daily streak
                                    </h3>
                                </div>
                    ...
                    <Reveal motionType={'zoom'}>
                        <div className="flex items-center justify-center pt-20 md:pb-7">
                            <h1 className="text-2xl font-bold lg:text-4xl">
                                <span className="text-[#BF5700] font-mono">WARNING:</span> <span className={`${darkMode ? 'text-gray-700' : 'text-gray-950'}`}>You will hate</span>  <span className="text-[#2cb74c]" style={{ letterSpacing: '1.5px' }}>fingo</span> <span className={`${darkMode ? 'text-gray-700' : 'text-gray-950'}`}>if...</span>
                            </h1>
                        </div>
